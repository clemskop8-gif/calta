...
# ============================================================
# 1. СЛОВАРИ ДЛЯ РЕРАЙТА (замена синонимов)
# ============================================================
SYNONYMS = {
    # Существительные
...
def rewrite_text(text):
    """Переписывает текст, заменяя слова на синонимы"""
    if not text:
        return text
...
def generate_unique_title(original_title):
    """Генерирует уникальный заголовок на основе оригинального"""
...
def generate_unique_summary(original_summary):
    """Генерирует уникальное описание на основе оригинального"""
